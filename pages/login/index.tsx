  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className={style.formLogin}>
        ...
        <input type="email" id="email" className={style.inputForm} autoComplete="off" value={mail} onChange={(e) => setMail(e.target.value)} required />
        <label htmlFor="password" className={style.labelForm} >mot de passe :</label>
        <input type="password" id="password" autoComplete="off" className={style.inputForm} value={password} onChange={(e) => setPassword(e.target.value)} required />
