describe("profile", function () {
  ...
  describe("withSession", function () {
    ...
    it("can edit my profil", function () {
      ...
      cy.get("[data-cy='firstname']").type("{selectall}Pepito");
      cy.get("[data-cy='lastname']").type("{selectall}Mi Corazon");
      cy.get("[data-cy='nickName']").type("{selectall}King Biscuit");
      cy.get("[data-cy='birthday']").type("1990-05-01", { force: true });
      cy.get("[data-cy='city']").type("{selectall}Mexico");
      cy.get("[data-cy='favoritePlate']").type("{selectall}Tacos");
      cy.get("[data-cy='description']").type(
        "{selectall}Je change ma desription"
      );
